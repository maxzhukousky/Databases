...
UNION ALL
SELECT 'country' AS table_name, MIN(LENGTH(country)) min, MAX(LENGTH(country)) max, AVG(LENGTH(country)) middle
FROM StudentsRB.country
UNION ALL
SELECT 'city' AS table_name, MIN(LENGTH(city_name)) min, MAX(LENGTH(city_name)) max, AVG(LENGTH(city_name)) middle
FROM StudentsRB.city
UNION ALL
SELECT 'region' AS table_name, MIN(LENGTH(region)) min, MAX(LENGTH(region)) max, AVG(LENGTH(region)) middle
